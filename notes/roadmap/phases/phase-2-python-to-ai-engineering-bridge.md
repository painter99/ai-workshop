...
## Goal
Connect Python logic to LLM APIs (OpenAI or Local Ollama).
...
- Packt ebook: "RAG-Driven Generative AI" (architecture overview only)

## OFFLINE STUDY
- Conceptual architecture of a RAG pipeline (Ingestion → Retrieval → Generation).
- Use "RAG-Driven Generative AI" chapters 1-2 for theory.
