# PAVEL — DETAIL ROADMAP (12 months, 5h/week, Linux, local-first)

**Goal:** Local-first Dify LLM apps + 1 fine-tuned SLM (LoRA/QLoRA) + agents
**Style:** low-friction, portfolio-ready outputs
...
- **Packt ebooks:** "RAG-Driven Generative AI", "Python ML By Example", "LLM Engineer's Handbook", "Mathematics of ML"
- **Packt videos:** "Dify – No-Code Chatbots & Workflows", "AI & LLM Engineering Mastery – GenAI/RAG" (optional accel)"
- **Owned books:** PY4E
- **Free Microsoft GitHub:** generative-ai-for-beginners, rag-time, edgeai-for-beginners, PhiCookBook
- **Free practice hub:** https://github.com/mlabonne/llm-course

---

## OPERATING RULE (prevents overload)

Per phase: **1 CORE + 1 REFERENCE + 1 LAB/Repo**
